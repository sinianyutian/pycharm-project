...
class PascalVOC2012SegmentationDatasetUnpair(SegmentationDatasetBase):
    ...
    def get_example(self, i):
        shuffle_int = np.random.randint(0, len(self.files), 2)
        data_file = self.files[shuffle_int[0]]
        # load image
        ...
        # load label
        data_file = self.files[shuffle_int[1]]
