...
if __name__ == '__main__':
    ...
    latent = Input(shape=(latent_size, ))
    image_class = Input(shape=(1,), dtype='int32')
    generator.load_weights('params_generator_epoch_049.hdf5')
    # get a fake image
    ...
    Image.fromarray(img).save(
        'plot_epoch_{0:03d}_generated.png'.format(4321))
    exit()
    ...
    # generated_images = generator.predict(
    #     [noise, sampled_labels], verbose=0)
    # generated_images = X_train[0:100]
    # generated_images = np.transpose(generated_images, [0, 2, 3, 1])
    #
    # # arrange them into a grid
    # img = (np.concatenate([r.reshape(-1, 32, 3)
    ...
    #
    # Image.fromarray(img).save(
    #     'plot_epoch_{0:03d}_generated.png'.format(1234))
    # exit()
    ...
    for epoch in range(nb_epochs):
        ...
        for index in range(nb_batches):
            ...
            # print(sampled_labels.reshape((-1,1)).shape)
