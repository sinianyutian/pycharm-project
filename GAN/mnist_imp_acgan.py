...
if __name__ == '__main__':
    ...
    discriminator.load_weights("mnist_impr_gan_params_discriminator_epoch_010.hdf5")
    ...
    generator.load_weights('mnist_impr_gan_params_generator_epoch_010.hdf5')
    ...
    for epoch in range(nb_epochs):
        ...
        generator.save_weights(
            'mnist_imp_acgan_params_generator_epoch_{0:03d}.hdf5'.format(epoch), True)
        discriminator.save_weights(
            'mnist_imp_acgan_params_discriminator_epoch_{0:03d}.hdf5'.format(epoch), True)
