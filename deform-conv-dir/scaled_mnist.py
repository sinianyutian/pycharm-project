...
from cnn import get_cnn, get_deform_cnn
...
model.load_weights('mnist_cnn.h5', by_name=True)
...
model.save_weights('models_deform_cnn.h5')

# --
# Evaluate deformable CNN

model.load_weights('models_deform_cnn.h5')
